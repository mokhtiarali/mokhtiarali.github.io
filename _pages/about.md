...
profile:
  ...
  more_info: >
    <p>Brookings, SD</p>
    <p><a href="mailto:Mukhtiar.Ali@jacks.sdstate.edu">Mukhtiar.Ali@jacks.sdstate.edu</a></p>
...
My doctoral trajectory builds on earlier work in medical image CNNs (breast cancer detection), human-state deep learning (driver drowsiness from eye-state video), and applied ML for social data. Today that arc continues through first-author work accepted at **CVPR 2026 (MULA Workshop)**, co-first-author work under review at **MICCAI 2026**, and two evaluation-suite efforts in preparation targeting CVPR 2027 on long-form video description.
